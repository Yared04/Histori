...
const ClaimReviewPopup: React.FC<ClaimReviewPopupProps> = ({setConfirm, handleClaimReview}) => {
  ...
  return (
    <div className=''>
    <div ref={dropdownRef} className=' fixed top-[12rem] text-black right-1/3 bg-gradient-to-b  z-40 bg-white max-w-sm p-4 flex flex-col rounded-md gap-5 items-center'>
